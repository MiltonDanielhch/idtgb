...
@section('page_title', 'Documentos del Trámite '.$tramite->nro_tramite)
                ...
                <div class="panel panel-bordered" style="margin-bottom: 0;">
                    <div class="panel-body" style="padding: 0;">
                        <div class="col-md-8" style="padding: 0;">
                            <h1 class="page-title">
                                <i class="voyager-folder"></i> Documentos del Trámite <strong>{{ $tramite->nro_tramite }}</strong>
                            </h1>
                        </div>
                        <div class="col-md-4 text-right" style="margin-top: 30px;">
                            @can('create', App\Models\Documento::class)
                                <a href="{{ route('admin.tramites.documentos.create', $tramite) }}" class="btn btn-success">
                                    <i class="voyager-plus"></i> Subir Documento
                                </a>
                            @endcan
                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" id="input-search" class="form-control" placeholder="🔍 Buscar tipo...">
                            </div>
                        </div>
...
<script>
    ...
    window.list = function (page = 1) {
        ...
        const url   = '{{ route("admin.tramites.documentos.ajax.list", $tramite) }}';
