...
@section('page_title', 'Exenciones aplicadas al Trámite '.$tramite->nro_tramite)
                ...
                <div class="panel panel-bordered" style="margin-bottom: 0;">
                    <div class="panel-body" style="padding: 0;">
                        <div class="col-md-8" style="padding: 0;">
                            <h1 class="page-title">
                                <i class="voyager-gift"></i> Exenciones del Trámite <strong>{{ $tramite->nro_tramite }}</strong>
                            </h1>
                        </div>
                        <div class="col-md-4 text-right" style="margin-top: 30px;">
                            @can('create', App\Models\TramiteExencion::class)
                                <a href="{{ route('admin.tramites.exenciones.create', $tramite) }}" class="btn btn-success">
                                    <i class="voyager-plus"></i> Aplicar Exención
                                </a>
                            @endcan
                            <a href="{{ route('admin.tramites.show', $tramite) }}" class="btn btn-warning">
                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" id="input-search" class="form-control" placeholder="🔍 Buscar exención...">
                            </div>
                        </div>
...
<script>
    ...
    window.list = function (page = 1) {
        ...
        const url   = '{{ route("admin.tramites.exenciones.ajax.list", $tramite) }}';
