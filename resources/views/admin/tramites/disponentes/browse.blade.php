...
@section('page_title', 'Disponentes del Trámite '.$tramite->nro_tramite)
                ...
                <div class="panel panel-bordered" style="margin-bottom: 0;">
                    <div class="panel-body" style="padding: 0;">
                        <div class="col-md-8" style="padding: 0;">
                            <h1 class="page-title">
                                <i class="voyager-person"></i> Disponentes del Trámite <strong>{{ $tramite->nro_tramite }}</strong>
                            </h1>
                        </div>
                        <div class="col-md-4 text-right" style="margin-top: 30px;">
                            @can('create', App\Models\DisponenteTramite::class)
                                <a href="{{ route('admin.tramites.disponentes.create', $tramite) }}" class="btn btn-success">
...
<script>
    ...
    window.list = function (page = 1) {
        ...
        const url   = '{{ route("admin.tramites.disponentes.ajax.list", $tramite) }}';
