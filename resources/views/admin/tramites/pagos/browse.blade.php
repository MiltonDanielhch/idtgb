...
@section('page_title', 'Pagos del Trámite '.$tramite->nro_tramite)
                ...
                <div class="panel panel-bordered" style="margin-bottom: 0;">
                    <div class="panel-body" style="padding: 0;">
                        <div class="col-md-8" style="padding: 0;">
                            <h1 class="page-title">
                                <i class="voyager-dollar"></i> Pagos del Trámite <strong>{{ $tramite->nro_tramite }}</strong>
                            </h1>
                        </div>
                        <div class="col-md-4 text-right" style="margin-top: 30px;">
                            @can('create', App\Models\Pago::class)
                                @if($tramite->estado !== 'Pagado')
                                    <a href="{{ route('admin.tramites.pagos.create', $tramite) }}" class="btn btn-success">
                                        <i class="voyager-plus"></i> Registrar Pago
                                    </a>
                                @else
                                    <span class="label label-success">Trámite ya pagado</span>
                                @endif
                            @endcan
                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" id="input-search" class="form-control" placeholder="🔍 Buscar nro operación...">
                            </div>
                        </div>
...
<script>
    ...
    window.list = function (page = 1) {
        ...
        const url   = '{{ route("admin.tramites.pagos.ajax.list", $tramite) }}';
