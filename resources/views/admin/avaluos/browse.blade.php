                ...
                <div class="panel panel-bordered" style="margin-bottom: 0;">
                    <div class="panel-body" style="padding: 0;">
                        ...
                        <div class="col-md-4 text-right" style="margin-top: 30px;">
                            @can('create', App\Models\Avaluo::class)
                                <a href="{{ route('admin.avaluos.create') }}" class="btn btn-success">
                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" id="input-search" class="form-control" placeholder="🔍 Buscar catastro, perito, tipo...">
                            </div>
                        </div>
...
<script>
    ...
    window.list = function (page = 1) {
        ...
        const url   = '{{ route("admin.avaluos.ajax.list") }}';
        const search = $('#input-search').val() || '';
        const inmuebleId = '{{ request("inmueble_id") }}'; // ← filtro desde botón

        $.get(url, {search, paginate: window.countPage, page, inmueble_id: inmuebleId})
         .done(res => {
